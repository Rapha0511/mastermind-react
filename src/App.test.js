...
it('guesses the code',()=>{
  ...
  expect (
    guessDots.at(0)
    .hasClass('dot-'+stateAfterClick.guesses[0][0])
    ).toEqual(true)

    expect (
      guessDots.at(1)
      .hasClass('dot-'+stateAfterClick.guesses[0][1])
      ).toEqual(true)

      expect (
        guessDots.at(2)
        .hasClass('dot-'+stateAfterClick.guesses[0][2])
        ).toEqual(true)

        expect (
          guessDots.at(3)
          .hasClass('dot-'+stateAfterClick.guesses[0][3])
          ).toEqual(true)
